...
import 'package:flutter_application_2/utils/map_util.dart';
...
class _HospitalsScreenState extends State<HospitalsScreen> {
  ...
  void observeHospitals() {
    ...
    hspRef.onChildAdded.listen((event) {
      ...
      //31.4815° N, 74.3030° E
      var distance =
          getDistance(32.1877, 74.1945, hospital.latitude, hospital.longitude);
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) => HospitalListTile(
            hospital: hospitals.elementAt(index),
            press: () => {
                  MapUtils.openMap(hospitals.elementAt(index).latitude,
                      hospitals.elementAt(index).longitude)
                }),
      ),
    );
  }
